...
<div class="content-header row">
    ...
    <div class="content-header-left col-md-6 col-12 mb-2">
      <h5 class="content-header-title mb-0">Member</h5>
    </div>
    ...
    <div class="content-header-right col-md-6 col-12">
      <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
        <div class="btn-group" role="group">
            @can('add_member')
                <a href="{{ route('admin.'.request()->segment(2).'.create') }}" class="btn btn-primary btn-sm">Add Member</a>
            @endcan
       </div>
    </div>
</div>
                    ...
                    <table id="dataTableAjax" class="display dataTableAjax table table-striped table-bordered dom-jQuery-events" >
                        <thead>
                            <tr>
                                ...
                                @can(['edit_member','delete_member','read_member'])
                                <th>Action</th>
                                @endcan
                            </tr>
                        </thead>
