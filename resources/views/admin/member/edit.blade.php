...
{!! Form::open(['route'=>['admin.'.request()->segment(2).'.update',$member->id],'method'=>'put','files'=>true]) !!}
            ...
            <div class="row">
                <div class="col-md-4 col-sm-12">
                     ...
                     <div class="form-group{{ $errors->has('member_group') ? ' has-error' : '' }}">
                        ...
                        {!! Form::select('member_group',App\Model\MemberGroup::pluck('name','id'), $member->member_group, ['id' => 'member_group', 'class' => 'form-control','placeholder'=>'Select Member Group']) !!}
                    ...
                    <div class="form-group {{ $errors->has('date_of_birth') ? ' has-error' : '' }}">
                        ...
                        {!! Form::text('date_of_birth', $member->date_of_birth, ['class' => 'form-control pickadate', 'placeholder' => 'Date Of Birth']) !!}
                    ...
                    <div class="form-group{{ $errors->has('address_1') ? ' has-error' : '' }}">
                        ...
                        <span class="required danger">*</span>
                        {!! Form::text('address_1', $member->address_1, ['class' => 'form-control', 'required' => 'required','placeholder'=>'Address1']) !!}
                    ...
                    <div class="form-group {{ $errors->has('district') ? ' has-error' : '' }}">
                        ...
                        <span class="required danger">*</span>
                        <span class="required danger">*</span>
                        {!! Form::text('district', $member->district, ['class' => 'form-control', 'placeholder' => 'District']) !!}
                    ...
                    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                        ...
                        <span class="required danger">*</span>
                        {!! Form::text('email', $member->email, ['class' => 'form-control', 'required' => 'required','placeholder'=>'Email']) !!}
                        <small class="text-danger">{{ $errors->first('email') }}</small>
                    </div>

                    <div class="form-group{{ $errors->has('aadhar_no') ? ' has-error' : '' }}">
                        {!! Form::label('aadhar_no', 'Aadhar No.') !!}
                        {!! Form::text('aadhar_no', $member->aadhar_no, ['class' => 'form-control', 'placeholder' => 'Aadhar No.']) !!}
                        <small class="text-danger">{{ $errors->first('aadhar_no') }}</small>
                    </div>

                    <div class="form-group{{ $errors->has('mother_name') ? ' has-error' : '' }}">
                        {!! Form::label('mother_name', 'Mother Name') !!}
                        {!! Form::text('mother_name', $member->mother_name, ['class' => 'form-control', 'placeholder'=>'Mother Name']) !!}
                    ...
                    <div class="form-group{{ $errors->has('monthly_income') ? ' has-error' : '' }}">
                        ...
                        {!! Form::text('monthly_income', $member->monthly_income, ['class' => 'form-control', 'placeholder' => 'Monthly Income']) !!}
                ...
                <div class="col-md-4 col-sm-12">
                    ...
                    <div class="form-group{{ $errors->has('introducer_member_name') ? ' has-error' : '' }}">
                        ...
                        {!! Form::select('introducer_member_name', App\Model\Member::where('user_type', 2)->pluck('name','id'), $member->introducer_member_name, ['id' => 'introducer_member_name', 'class' => 'form-control', 'placeholder'=>'Introducer Member Name']) !!}
                    ...
                    <div class="form-group {{ $errors->has('enrollment_date') ? ' has-error' : '' }}">
                        ...
                        {!! Form::text('enrollment_date', $member->enrollment_date, ['class' => 'form-control pickadate', 'placeholder' => 'Enrollment Date']) !!}
                    ...
                    <div class="form-group{{ $errors->has('address_2') ? ' has-error' : '' }}">
                        ...
                        {!! Form::text('address_2', $member->address_2, ['class' => 'form-control', 'placeholder' => 'Address2']) !!}
                    ...
                    <div class="form-group {{ $errors->has('pincode') ? ' has-error' : '' }}">
                        ...
                        <span class="required danger">*</span>
                        <span class="required danger">*</span>
                        {!! Form::text('pincode', $member->pincode, ['class' => 'form-control', 'placeholder' => 'Pincode']) !!}
                    ...
                    <div class="form-group{{ $errors->has('mobile_no') ? ' has-error' : '' }}">
                           ...
                           <span class="required danger">*</span>
                           {!! Form::text('mobile_no', $member->mobile_no, ['class' => 'form-control', 'required' => 'required','placeholder'=>'Mobile No.']) !!}
                       ...
                       <div class="form-group{{ $errors->has('pan') ? ' has-error' : '' }}">
                           {!! Form::label('pan', 'PAN') !!}
                           {!! Form::text('pan', $member->pan, ['class' => 'form-control', 'placeholder' => 'PAN']) !!}
                       ...
                       <div class="form-group{{ $errors->has('din') ? ' has-error' : '' }}">
                           {!! Form::label('din', 'DIN') !!}
                           {!! Form::text('din', $member->din, ['class' => 'form-control', 'placeholder' => 'DIN']) !!}
                ...
                <div class="col-md-4 col-sm-12">
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                        ...
                        <span class="required danger">*</span>
                        {!! Form::text('name', $member->name, ['class' => 'form-control', 'required' => 'required','placeholder'=>'Name']) !!}
                    ...
                    <div class="form-group{{ $errors->has('gender') ? ' has-error' : '' }}">
                        ...
                        <span class="required danger">*</span>
                        {!! Form::select('gender', ['Male'=>'Male','Female'=>'Female'], $member->gender, ['id' => 'gender', 'class' => 'form-control', 'required' => 'required', 'placeholder'=>'Select Gender']) !!}
                     ...
                     <div class="form-group {{ $errors->has('state') ? ' has-error' : '' }}">
                        ...
                        <span class="required danger">*</span>
                        {!! Form::select('state', App\Model\State::pluck('name','name'), $member->state, ['id' => 'state', 'class' => 'form-control select2', 'placeholder' => 'State']) !!}
                    ...
                    <div class="form-group{{ $errors->has('marital_status') ? ' has-error' : '' }}">
                        ...
                        <span class="required danger">*</span>
                        {!! Form::select('marital_status', ['Married'=>'Married','UnMarried'=>'UnMarried'], $member->marital_status, ['id' => 'marital_status', 'class' => 'form-control', 'required' => 'required', 'placeholder'=>'Select Marital Status']) !!}
                   ...
                   <div class="form-group{{ $errors->has('relative_name') ? ' has-error' : '' }}">
                       ...
                       {!! Form::text('relative_name', $member->relative_name, ['class' => 'form-control', 'placeholder' => 'Relative Name']) !!}
                   ...
                   <div class="form-group {{ $errors->has('appointment_date') ? ' has-error' : '' }}">
                    ...
                    {!! Form::text('appointment_date', $member->appointment_date, ['class' => 'form-control pickadate', 'placeholder' => 'Appointment Date']) !!}
    ...
    <div class="card-content">
        ...
        <div class="card-body">
            ...
            <div class="form-group{{ $errors->has('bank_name') ? ' has-error' : '' }}">
                ...
                {!! Form::text('bank_name', $member->bank_name, ['class' => 'form-control', 'required' => 'required','placeholder'=>'Bank Name']) !!}
            ...
            <div class="form-group{{ $errors->has('ifs_code') ? ' has-error' : '' }}">
                ...
                {!! Form::text('ifs_code', $member->ifs_code, ['class' => 'form-control', 'required' => 'required','placeholder'=>'IFS Code']) !!}
         ...
         <div class="col-md-4 col-sm-12">
            ...
            <div class="form-group{{ $errors->has('bank_address') ? ' has-error' : '' }}">
                ...
                {!! Form::text('bank_address', $member->bank_address, ['class' => 'form-control', 'required' => 'required','placeholder'=>'Bank Address']) !!}
                <small class="text-danger">{{ $errors->first('bank_address') }}</small>
            </div>

            <div class="form-group{{ $errors->has('bank_account') ? ' has-error' : '' }}">
                {!! Form::label('bank_account', 'Bank Account') !!}
                {!! Form::text('bank_account', $member->bank_account, ['class' => 'form-control', 'required' => 'required','placeholder'=>'Bank Account']) !!}
         ...
         <div class="col-md-4 col-sm-12">
            ...
            <div class="form-group{{ $errors->has('account_type') ? ' has-error' : '' }}">
                ...
                {!! Form::select('account_type', ['Saving'=>'Saving Account','Current'=>'Current Account'], $member->account_type, ['id' => 'account_type', 'class' => 'form-control', 'required' => 'required', 'placeholder'=>'Select Account Type']) !!}
