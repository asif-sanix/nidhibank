...
<div class="card">
    <div class="card-content">
        <div class="card-body">
          {!! Form::open(['route'=>['admin.'.request()->segment(2).'.update',$rank->id],'method'=>'put','files'=>true]) !!}
             ...
             <div class="row">
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="form-group{{ $errors->has('rank') ? ' has-error' : '' }}">
                        ...
                        {!! Form::select('rank', ['9'=>'9','10'=>'10','11'=>'11','12'=>'12','13'=>'13','14'=>'14','15'=>'15'], $rank->rank, ['id' => 'rank', 'class' => 'form-control', 'required' => 'required', 'placeholder'=>'Rank']) !!}
                    ...
                    <div class="form-group{{ $errors->has('rank_definition') ? ' has-error' : '' }}">
                        ...
                        {!! Form::text('rank_definition', $rank->rank_definition, ['class' => 'form-control', 'required' => 'required','placeholder'=>'Rank Definition']) !!}
                    ...
                    <div class="form-group">
                        <div class="checkbox{{ $errors->has('active_status') ? ' has-error' : '' }}">
                            {!! Form::label('active_status', 'Active State') !!}<br>
                             {!! Form::checkbox('active_status', '1', $rank->status, ['id' => 'switch1','class'=>'switch']) !!} 
                        </div>
                     ...
                     <div class="form-group{{ $errors->has('rank_name') ? ' has-error' : '' }}">
                        ...
                        {!! Form::text('rank_name', $rank->rank_name, ['class' => 'form-control', 'required' => 'required','placeholder'=>'Rank Name']) !!}
