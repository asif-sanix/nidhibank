...
<div class="content-header row">
    ...
    <div class="content-header-left col-md-6 col-12 mb-2">
      <h5 class="content-header-title mb-0">Saving Account Scheme</h5>
    </div>
      ...
      <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
        <div class="btn-group" role="group">
            @can('add_saving_account_scheme')
                <a href="{{ route('admin.'.request()->segment(2).'.create') }}" class="btn btn-primary btn-sm">Add Saving Account Scheme</a>
            @endcan
       </div>
    </div>
</div>
                    ...
                    <table id="dataTableAjax" class="display dataTableAjax table table-striped table-bordered dom-jQuery-events" >
                        <thead>
                            <tr>
                                ...
                                <th>Interest Rate</th>
                                <th>Created at</th>
                                @can(['edit_saving_account_scheme','delete_saving_account_scheme','read_saving_account_scheme'])
                                <th>Action</th>
                                @endcan
                            </tr>
                        </thead>
                        ...
                        render: function(data, type, row) {
                            if (type === 'display') {
                                ...
                                @can(['edit_saving_account_scheme','delete_saving_account_scheme','read_saving_account_scheme'])
                                    ...
                                    @can('delete_saving_account_scheme')
