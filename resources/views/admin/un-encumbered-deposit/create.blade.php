            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="form-group{{ $errors->has('deposit_type') ? ' has-error' : '' }}">
                        ...
                        {!! Form::select('deposit_type', ['Scheduled Commercial Banks'=>'Scheduled Commercial Banks','Post Office'=>'Post Office'], null, ['id' => 'deposit_type', 'class' => 'form-control', 'required' => 'required', 'placeholder'=>'Select Deposit Type']) !!}
                    ...
                    <div class="form-group{{ $errors->has('bank_po_name') ? ' has-error' : '' }}">
                        ...
                        {!! Form::text('bank_po_name', null, ['class' => 'form-control', 'required' => 'required','placeholder'=>'Bank/PO Name']) !!}
                    ...
                    <div class="form-group{{ $errors->has('fd_amount') ? ' has-error' : '' }}">
                        ...
                        {!! Form::text('fd_amount', null, ['class' => 'form-control', 'placeholder' => 'FD Amount']) !!}
                    ...
                    <div class="form-group{{ $errors->has('fd_no') ? ' has-error' : '' }}">
                        ...
                        {!! Form::text('fd_no', null, ['class' => 'form-control', 'required' => 'required','placeholder'=>'FD No']) !!}
                        <small class="text-danger">{{ $errors->first('fd_no') }}</small>
                    </div>

                    <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                        {!! Form::label('address', 'Address') !!}
                        {!! Form::text('address', null, ['class' => 'form-control', 'required' => 'required','placeholder'=>'Address']) !!}
                    ...
                    <div class="form-group{{ $errors->has('annual_interest_rate') ? ' has-error' : '' }}">
                        ...
                        {!! Form::text('annual_interest_rate', null, ['class' => 'form-control', 'required' => 'required','placeholder'=>'Annual Interest Rate']) !!}
                ...
                <div class="col-md-6 col-sm-12">
                     ...
                     <div class="form-group">
                        <div class="checkbox{{ $errors->has('is_fd_mandatory') ? ' has-error' : '' }}">
                            {!! Form::label('is_fd_mandatory', 'Is FD Mandatory') !!}<br>
                             {!! Form::checkbox('is_fd_mandatory', '1', 0, ['id' => 'switch1','class'=>'switch']) !!} 
                        </div>
                    ...
                    <div class="form-group {{ $errors->has('open_date') ? ' has-error' : '' }}">
                        ...
                        {!! Form::text('open_date', null, ['class' => 'pickadate form-control', 'placeholder' => 'Open Date']) !!}
                    ...
                    <div class="form-group {{ $errors->has('maturity_date') ? ' has-error' : '' }}">
                        ...
                        {!! Form::text('maturity_date', null, ['class' => 'pickadate form-control', 'placeholder' => 'Maturity Date']) !!}
