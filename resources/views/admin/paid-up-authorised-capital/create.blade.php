            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <div class="form-group{{ $errors->has('paid_up_capital') ? ' has-error' : '' }}">
                        ...
                        {!! Form::text('paid_up_capital', null, ['class' => 'form-control', 'placeholder' => 'Paid Up Capital']) !!}
                    ...
                    <div class="form-group{{ $errors->has('authorised_capital') ? ' has-error' : '' }}">
                        ...
                        <span class="required danger">*</span>
                        {!! Form::text('authorised_capital', null, ['class' => 'form-control', 'placeholder' => 'Authorised Capital']) !!}
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="form-group {{ $errors->has('date') ? ' has-error' : '' }}">
                        ...
                        {!! Form::text('date', null, ['class' => 'form-control pickadate', 'placeholder' => 'Date']) !!}
