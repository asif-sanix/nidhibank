...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Sep 14, 2020 at 07:51 AM
...
(2, 'AB1', 7, '2020-09-14', 'Female', 'adfasf', 2, NULL, NULL, 'dsfs', 'Andaman and Nicobar (AN)', 'dfsd', '456321', '2020-09-14', NULL, '7896541230', 'dfdsa@rfer.fre', 'dfsd', 'fdsf', 'dsfsd', 'dcfsd', 'cds', 'df', 'dsf', 'Current', 'ds', '2020-09-14 07:19:13', '2020-09-14 07:19:13'),
...
('saving_accounts_setting', 'Saving Accounts', NULL, NULL, 3, 1),
...
('site_setting', 'Site Setting', 'ft-sliders', NULL, 5, 1),
...
CREATE TABLE IF NOT EXISTS `saving_account_applications` (
  ...
  `statues` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0=submit 1=approved  2=cancel',
