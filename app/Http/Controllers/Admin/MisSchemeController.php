...
use App\Http\Resources\Admin\MisScheme\MisSchemeCollection;
use App\Model\Capital;
use App\Model\MisScheme;
use Carbon\Carbon;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Auth;

class MisSchemeController extends Controller
{
    /**
    ...
    {
        if ($request->ajax()) {
            $datas = MisScheme::orderBy('created_at','desc')->select(['id','name','scheme_code','interest_payout','created_at','interest_rate']);
            ...
            return response()->json(new MisSchemeCollection($datas));
           
        }

        return view('admin.mis.scheme.list');
    }
    ...
    {
        return view('admin.mis.scheme.create');
    }
    ...
    {
        $scheme = MisScheme::find($id);
        return view('admin.mis.scheme.edit', compact('scheme')); 
    }
    ...
    {
        if(MisScheme::where('id',$id)->delete()){
