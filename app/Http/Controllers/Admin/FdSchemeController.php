...
use App\Http\Resources\Admin\FdScheme\FdSchemeCollection;
use App\Model\Capital;
use App\Model\FdScheme;
use Carbon\Carbon;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Auth;

class FdSchemeController extends Controller
{
    /**
    ...
    {
        if ($request->ajax()) {
            $datas = FdScheme::orderBy('created_at','desc')->select(['id','name','scheme_code','interest_payout','created_at','interest_rate']);
            ...
            return response()->json(new FdSchemeCollection($datas));
           
        }

        return view('admin.fixed-deposit.scheme.list');
    }
    ...
    {
        return view('admin.fixed-deposit.scheme.create');
    }
    ...
    {
        $scheme = FdScheme::find($id);
        return view('admin.fixed-deposit.scheme.edit', compact('scheme')); 
    }
    ...
    {
        if(FdScheme::where('id',$id)->delete()){
